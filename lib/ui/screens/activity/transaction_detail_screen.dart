...
import 'package:how_much_do_i_owe_you/providers/dummy_transaction_provider.dart';
...
class TransactionDetailScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final transactionAsync = ref.watch(dummyTransactionDataProvider(transactionId));
